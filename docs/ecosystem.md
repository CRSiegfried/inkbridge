...
- **[supernotelib](https://pypi.org/project/supernotelib/)**
  ...
  spec. `inkbridge` depends on this directly for reading notebooks.
...
HTTP server, no public API spec — reverse-engineerable), **Supernote Cloud**
sync, USB mass-storage/MTP, and ADB (closed by default, unlockable; no
official SSH). See
